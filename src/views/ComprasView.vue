                            ...
                            <v-container>
                                <v-row>
                                    <v-col md="6" cols="12">
                                        ...
                                        <p class="text-caption">Si no encuentras el proveedor, puedes <router-link
                                                class="text-caption" :to="{ name: 'listado-de-proveedores' }">agregar
                                                uno</router-link></p>
                                    </v-col>
                                    <v-col md="6" cols="12">
                                ...
                                <v-row>
                                    ...
                                    <v-col md="4" cols="6">
                                        <v-text-field label="Descripción" outlined v-model="articulo.descripcion"
                                            readonly variant="underlined"></v-text-field>
                                    </v-col>
                                    <v-col md="4" cols="6">
                            ...
                            <v-row>
                                <v-col>
                                    <v-text-field label="Monto abonado" v-model="abonado"
                                        variant="outlined"></v-text-field>
                                    <p class="text-caption">Ingrese el monto abonado para el registro de caja</p>
                                </v-col>
                                <v-col cols="12" md="4">
                                    <v-btn color="primary" @click="abonado = total" variant="plain" size="small">Pago
                                        total</v-btn>
                                </v-col>
                            </v-row>
                        </v-card-text>
