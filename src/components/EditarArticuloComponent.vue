        ...
        <v-form :valid="valido">
            <v-card title="Editar Articulo" :loading="cargando" width="600">
                <v-card-text>
                    <v-container>
                        <v-row>
                            <v-col cols="6" v-if="!articulo.es_producto">
                        ...
                        <v-row>
                            ...
                            <v-col cols="6">
                                <v-checkbox label="Es un producto elaborado"
                                    v-model="articulo.es_producto"></v-checkbox>
                            </v-col>
                        </v-row>
                        <v-row>
    ...
    export default {
        ...
        methods: {
            ...
            guardarArticulo() {
                ...
                datos.append('es_producto', this.articulo.es_producto ? 1 : 0);
        ...
        mounted() {
            this.getProveedores();
            this.getCategorias();
            this.articulo.es_producto == 1 ? this.articulo.es_producto = true : this.articulo.es_producto = false;
        },
        setup() {
